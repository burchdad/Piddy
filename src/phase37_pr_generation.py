...
if __name__ == '__main__':
    ...
    print("=" * 70)
    print("When ready, this PR would be created with:")
    print(f"  Title: {pr_content.description.title}")
    print(f"  Branch: piddy/auto/cleanup-dead-code")
    print(f"  Confidence: {pr_content.reasoning.confidence:.1%}")
